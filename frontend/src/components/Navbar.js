      ...
      <div className="dropdown">
        ...
        <i className="fa fa-caret-down"></i>{' '}
                ...
                <ul className="dropdown-content" >
                        ...
                        {user &&<li> <Link  style={{color:'#f6f6f6'}} to="/resume"> Create Resume</Link> </li>}
                        {user &&<li> <Link  style={{color:'#f6f6f6'}} to="/khadamnigpt"> KhadamniGpt</Link> </li>}
                        {user &&<li> <Link  style={{color:'#f6f6f6'}} to="/khadamnimap"> Search a location</Link> </li>}
                        <hr/>
